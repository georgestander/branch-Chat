...
- Always commit immediately after each completed logical change once feedback loops pass
- Stage only files changed for that logical change; ignore untouched or unrelated worktree changes
