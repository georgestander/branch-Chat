/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 10340b3b7a627eb84a82527a07fa2ac3)
// Runtime types generated with workerd@1.20251001.0 2025-08-21 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "ConversationStoreDO" | "ConversationDirectoryDO" | "AccountDO";
	}
	interface Env {
		...
		AccountDO: DurableObjectNamespace<import("./src/worker").AccountDO>;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "OPENAI_API_KEY" | "BYOK_ENCRYPTION_SECRET">> {}
}
